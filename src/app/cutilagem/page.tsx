                ...
                <section className="relative px-4 py-8 md:py-12">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="text-center mb-8">
                            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-3 leading-tight font-[family-name:var(--font-montserrat)]">
                ...
                <section className="py-12 px-4 bg-[#111]">
                    <div className="max-w-3xl mx-auto">
                        <h2 className="text-2xl md:text-3xl font-bold text-center mb-8 text-white font-[family-name:var(--font-montserrat)]">
                            Compre o <span className="bg-gradient-to-r from-[#D4AF37] via-[#F4E4BC] to-[#D4AF37] bg-clip-text text-transparent">Cutilagem Avançada</span>, se você quer
                        </h2>
                ...
                <section className="py-12 px-4 bg-gradient-to-b from-[#111] to-[#0a0a0a]">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="bg-[#111] border border-gray-800 rounded-xl p-6 mb-4 flex flex-col md:flex-row items-center gap-6">
                            <div className="w-20 h-20 flex-shrink-0 bg-[#1a1a1a] rounded-lg flex items-center justify-center border border-[#22C55E]/30">
                                <i className="fa-solid fa-video text-3xl text-[#22C55E]"></i>
                            </div>
                            <div className="flex-1 text-center md:text-left">
                                <h3 className="text-xl font-bold text-white mb-2 font-[family-name:var(--font-montserrat)]">Aula prática: O Segredo da Cutilagem Perfeita</h3>
                                <p className="text-gray-400 text-sm font-[family-name:var(--font-poppins)]">Copie os meus movimentos exatos no vídeo explicativo</p>
                            </div>
                        ...
                        <div className="bg-[#111] border border-gray-800 rounded-xl p-6 mb-4 flex flex-col md:flex-row items-center gap-6">
                            <div className="w-20 h-20 flex-shrink-0 bg-[#1a1a1a] rounded-lg flex items-center justify-center border border-[#22C55E]/30">
                                <i className="fa-solid fa-book text-3xl text-[#22C55E]"></i>
                            </div>
                            <div className="flex-1 text-center md:text-left">
                                <h3 className="text-xl font-bold text-white mb-2 font-[family-name:var(--font-montserrat)]">Apostila: O passo a passo da cutilagem perfeita</h3>
                                <p className="text-gray-400 text-sm font-[family-name:var(--font-poppins)]">Download em PDF para consultar quando quiser</p>
                            </div>
                            <div className="text-right">
                        ...
                        {/* Bônus */}
                        <div className="bg-gradient-to-r from-[#22C55E]/20 to-[#111] border border-[#22C55E]/50 rounded-xl p-6 mb-8 flex flex-col md:flex-row items-center gap-6">
                            <div className="w-20 h-20 flex-shrink-0 bg-[#22C55E] rounded-lg flex items-center justify-center">
                            ...
                            <div className="flex-1 text-center md:text-left">
                                ...
                                <h3 className="text-xl font-bold text-white mb-2 font-[family-name:var(--font-montserrat)]">Checklist de Materiais Profissionais</h3>
                    ...
                    <div className="max-w-xl mx-auto">
                        <div className="bg-[#111] border-2 border-gray-700 rounded-2xl overflow-hidden">
                            ...
                            <div className="p-6 md:p-8 text-center">
                                <h3 className="text-2xl font-bold mb-6 text-white font-[family-name:var(--font-montserrat)]">Leve todos os materiais abaixo, por um preço SIMBÓLICO, somente hoje:</h3>

                                {/* Preço */}
                                <div className="mb-6">
                                    <p className="text-white text-sm mb-2 font-[family-name:var(--font-poppins)]">Preço de Lançamento: <span className="text-red-500 line-through">R$ 200,00</span></p>
                                    <p className="text-white mb-4 font-[family-name:var(--font-poppins)]">Somente hoje por apenas {PARCELAS} de:</p>
                ...
                <section className="py-12 px-4 bg-[#0a0a0a]">
                    <div className="max-w-3xl mx-auto">
                        <div className="flex flex-col md:flex-row items-center gap-8 bg-[#111] border border-gray-800 rounded-xl p-6 md:p-8">
                            <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-[#22C55E] flex-shrink-0">
                                <Image
                                    src="/images/card_imagem_mariana1.png"
                                    alt="Mariana Nails"
                                    width={128}
                            ...
                            <div className="text-center md:text-left">
                                <h3 className="text-xl font-bold text-[#22C55E] mb-2 font-[family-name:var(--font-montserrat)]">Quem é Mariana Nails?</h3>
                                <p className="text-white leading-relaxed font-[family-name:var(--font-lora)]">
