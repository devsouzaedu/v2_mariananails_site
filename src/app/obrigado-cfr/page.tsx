...
// PÁGINA PRINCIPAL
// ============================================
export default function ObrigadoCFRPage() {
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-[#0a0a0a] text-white font-[family-name:var(--font-poppins)]">
                ...
                {/* ========== HEADER COM LOGO ========== */}
                <header className="py-6 px-4 border-b border-gray-900">
                ...
                <div className="max-w-lg mx-auto px-6 py-10">
                    ...
                    <div className="text-center mb-8">
                        <h1 className="text-4xl md:text-5xl font-black text-[#D4AF37] mb-4 font-[family-name:var(--font-montserrat)]">
                            Parabéns, meu amor!
                        </h1>
                    ...
                    <div className="text-center mb-10">
                        <h2 className="text-2xl md:text-3xl text-white mb-3 font-[family-name:var(--font-montserrat)] leading-tight">
                            <span className="text-[#D4AF37] font-bold">Você foi selecionada</span> para<br />
                            ler o meu
                        </h2>
                        <p className="font-[family-name:var(--font-lora)] italic text-4xl md:text-5xl text-white leading-tight">
                            diário de uma<br />
                            <span className="text-[#D4AF37]">nail designer</span>
                        </p>
                    </div>
                    ...
                    <div className="mb-10">
                        ...
                        <div className="space-y-6">
                            {/* Item 1 */}
                            <div className="flex items-start gap-4 bg-[#111] border border-gray-800 p-5 rounded-2xl">
                    ...
                    <div className="bg-[#D4AF37]/10 border-2 border-[#D4AF37]/30 rounded-2xl p-6 mb-10 flex items-center gap-4">
                        <div className="w-14 h-14 bg-[#D4AF37] rounded-full flex items-center justify-center flex-shrink-0">
                            <i className="fa-solid fa-check text-[#0a0a0a] text-xl"></i>
                        </div>
                    ...
                    {/* ================================================================ */}
                    {/* ========== ORDER BUMP - O CÓDIGO DA FIBRA REALISTA ========== */}
                    {/* ================================================================ */}
                            ...
                            <div className="bg-[#0f0f0f] p-5 md:p-6">
                                ...
                                >
                                    ...
                                    <div>
                                        <p className="text-white font-black text-lg md:text-xl font-[family-name:var(--font-montserrat)] leading-tight">
                                            SIM! Eu quero adicionar o <span className="bg-gradient-to-r from-[#D4AF37] via-[#F4E4BC] to-[#D4AF37] bg-clip-text text-transparent">Código da Fibra Realista</span> com <span className="text-[#22C55E]">desconto exclusivo</span>
                                        </p>
                                ...
                                <div className="flex flex-col sm:flex-row items-center gap-5 mb-5">
                                    <div className="w-full sm:w-2/5 flex-shrink-0">
                                        <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border border-[#D4AF37]/30 rounded-xl p-6 text-center">
                                            <div className="text-5xl mb-3">💎</div>
                                            <p className="text-[#D4AF37] font-black text-lg font-[family-name:var(--font-montserrat)]">CFR</p>
                                            <p className="text-gray-400 text-xs mt-1">O Código da Fibra Realista</p>
                                        </div>
                                    </div>
                                    <div className="w-full sm:w-3/5">
                                        <h4 className="text-white font-bold text-xl md:text-2xl mb-2 font-[family-name:var(--font-montserrat)]">
                                            O Código da Fibra Realista
                                        </h4>
                                        <p className="text-gray-300 text-sm md:text-base mb-3 leading-relaxed">
                                            O método completo para fazer <strong className="text-white">alongamentos em fibra de vidro com aspecto 100% natural</strong>. Domine a técnica que faz suas clientes amarem o resultado.
                                        </p>
                                        <ul className="space-y-2 text-sm text-gray-300">
                                            <li className="flex items-center gap-2">
                                                <i className="fa-solid fa-check text-[#22C55E] text-xs"></i>
                                                <span>Preparação da Unha Natural</span>
                                            </li>
                                            <li className="flex items-center gap-2">
                                                <i className="fa-solid fa-check text-[#22C55E] text-xs"></i>
                                                <span>Aplicação de Fibra com Aspecto Realista</span>
                                            </li>
                                            <li className="flex items-center gap-2">
                                                <i className="fa-solid fa-check text-[#22C55E] text-xs"></i>
                                                <span>Curvatura C e Modelagem Perfeita</span>
                                            </li>
                                            <li className="flex items-center gap-2">
                                                <i className="fa-solid fa-check text-[#22C55E] text-xs"></i>
                                                <span>Acabamento Profissional Invisível</span>
                                            </li>
                                            <li className="flex items-center gap-2">
                                                <i className="fa-solid fa-check text-[#22C55E] text-xs"></i>
                                                <span>Manutenção e Reposição + Bônus</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div className="bg-[#1a1a1a] rounded-xl p-4 mb-5 text-center border border-gray-800">
                                    <p className="text-gray-400 text-sm mb-1">
                                        Preço normal: <span className="text-red-500 line-through font-bold">R$ 197,00</span>
                                    </p>
                                    ...
                                    <div className="flex items-baseline justify-center gap-1">
                                        ...
                                        <span className="text-6xl md:text-7xl font-black text-[#22C55E] font-[family-name:var(--font-montserrat)]">67</span>
                                        <span className="text-2xl text-[#22C55E] font-bold font-[family-name:var(--font-montserrat)]">,00</span>
                                    </div>
                                    <p className="text-[#22C55E] font-bold text-sm mt-1">Economía de R$ 130,00 💰</p>
                                </div>

                                {/* CTA do Order Bump */}
                                <a
                                    id="btn-order-bump-cfr"
                                    href={ORDER_BUMP_URL}
                                    target="_blank"
                                ...
                                >
                                    🔥 QUERO A FIBRA REALISTA POR R$67!
                                </a>
                                ...
                                <div className="mt-4 bg-[#C41E3A]/10 border border-[#C41E3A]/30 rounded-lg p-3 text-center">
                                    <p className="text-[#C41E3A] text-sm font-bold">
                                        ⚠️ Essa oferta de R$67 é EXCLUSIVA para quem acabou de comprar o Manual de Cutilagem. Se você sair desta página, o preço volta para R$197.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-gradient-to-br from-[#1c1c1c] to-[#0c0c0c] border border-[#D4AF37]/30 rounded-3xl p-8 text-center shadow-2xl">
                        <p className="text-white text-xl md:text-2xl mb-6 font-[family-name:var(--font-montserrat)] leading-relaxed">
                            ...
                            <span className="font-bold bg-gradient-to-r from-[#D4AF37] via-[#F4E4BC] to-[#D4AF37] bg-clip-text text-transparent">Nail Designer</span>?
                        </p>
