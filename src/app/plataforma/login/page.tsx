      ...
      <div className="max-w-md w-full">
        <div className="bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-800 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-zinc-400">Plataforma de Ensino Mariana Nails</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-zinc-400">
              Não tem uma conta?{' '}
              <Link href="/plataforma/cadastro" className="text-pink-500 font-semibold hover:text-pink-400 transition">
                Cadastre-se
              </Link>
            </p>
          </div>
