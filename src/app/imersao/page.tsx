...
// Domingos de março de 2026
const PROXIMAS_TURMAS = [
    { dia: '01', mes: 'MAR', diaSemana: 'Domingo', completo: '01 de Março' },
    { dia: '08', mes: 'MAR', diaSemana: 'Domingo', completo: '08 de Março' },
    { dia: '15', mes: 'MAR', diaSemana: 'Domingo', completo: '15 de Março' },
    { dia: '22', mes: 'MAR', diaSemana: 'Domingo', completo: '22 de Março' },
    { dia: '29', mes: 'MAR', diaSemana: 'Domingo', completo: '29 de Março' },
];
    ...
    return (
        <>
            ...
            <Head>
                ...
                <title>Imersão Presencial Nail Designer em Barueri | Mariana Nails & Gilmara Oliver</title>
                <meta name="description" content="Aprenda Nail Design do zero ao profissional na imersão presencial em Barueri com Mariana Nails e Gilmara Oliver. 2 dias intensivos de prática. Próximas turmas em Março!" />
            </Head>
            ...
            <div className="min-h-screen bg-[#0a0a0a] text-white font-[family-name:var(--font-poppins)]">
                ...
                {/* ========== PRÓXIMAS TURMAS - DOMINGOS DE MARÇO ========== */}
                <section className="py-12 px-4 bg-gradient-to-b from-[#0a0a0a] to-[#111]">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-2xl md:text-3xl font-bold text-center mb-3 text-white font-[family-name:var(--font-montserrat)]">
                            Próximas <span className="bg-gradient-to-r from-[#D4AF37] via-[#F4E4BC] to-[#D4AF37] bg-clip-text text-transparent">Turmas</span>
                        </h2>
                        <p className="text-gray-400 text-center mb-8 text-sm md:text-base">
                            Domingos de Março de 2026 — Escolha a melhor data para você!
                        </p>

                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
                            {PROXIMAS_TURMAS.map((turma, index) => (
                                <a
                                    key={index}
                                    href={CHECKOUT_URL}
                                    target="_blank"
                                ...
                                >
                                    <div className="
                                        ...
                                        border-2 border-[#D4AF37]/40 hover:border-[#D4AF37]
                                    ...
                                    ">
                                        ...
                                        <div className="absolute inset-0 bg-gradient-to-b from-[#D4AF37]/0 to-[#D4AF37]/0 group-hover:from-[#D4AF37]/10 group-hover:to-[#D4AF37]/5 transition-all duration-400 rounded-2xl"></div>
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <div className="mt-3">
                                                <span className="text-4xl md:text-5xl font-black text-white font-[family-name:var(--font-montserrat)] block leading-none">{turma.dia}</span>
                                                <span className="text-lg font-bold text-[#D4AF37] font-[family-name:var(--font-montserrat)] block mt-1">{turma.mes}</span>
                                            </div>
                        ...
                        <p className="text-center mt-6 text-gray-500 text-sm">
                            ...
                            Clique na data desejada para garantir sua vaga. As turmas possuem vagas limitadas!
                        </p>
                    </div>
                </section>
                    ...
                    <div className="max-w-xl mx-auto">
                        <div className="bg-[#0a0a0a] border-2 border-[#D4AF37]/50 rounded-2xl overflow-hidden shadow-2xl shadow-[#D4AF37]/10">
                            ...
                            <div className="p-6 md:p-8 text-center">
                                {/* Próximas datas em destaque */}
                                <div className="mb-6">
                                    <p className="text-[#D4AF37] font-bold text-sm uppercase tracking-wider mb-3">
                                        <i className="fa-solid fa-fire mr-1"></i> Próximas turmas — Março 2026
                                    </p>
                                    <div className="flex flex-wrap justify-center gap-2">
                                        {PROXIMAS_TURMAS.map((turma, index) => (
                                            <div key={index} className="bg-[#D4AF37]/10 border border-[#D4AF37]/30 rounded-lg px-3 py-2 text-center min-w-[60px]">
                                                <span className="text-lg font-black text-white block leading-none">{turma.dia}</span>
                                                <span className="text-[10px] font-bold text-[#D4AF37] uppercase">{turma.mes}</span>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                ...
                <section className="py-16 px-4 bg-gradient-to-b from-[#111] to-[#0a0a0a]">
                    <div className="max-w-xl mx-auto text-center">
                        ...
                        {/* Datas em destaque no CTA final */}
                        <div className="flex flex-wrap justify-center gap-2 mb-4">
                            {PROXIMAS_TURMAS.map((turma, index) => (
                                <span key={index} className="bg-[#D4AF37]/15 border border-[#D4AF37]/40 text-white text-sm font-bold px-3 py-1 rounded-full">
                                    {turma.completo}
                                </span>
                            ))}
                        </div>
                ...
                <footer className="py-8 px-4 bg-black text-center border-t border-gray-900">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 text-xs text-gray-700">
                        ...
                        <span>•</span>
                        <a id="btn-whatsapp-footer-imersao" href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">Suporte via WhatsApp</a>
                    </div>
                </footer>
            </div>
        </>
