...
export default function Fature4000ComUnhasEm2025() {
  return (
    <div className="min-h-screen bg-pink-50 text-gray-800">
      ...
      <section className="py-16 px-4 bg-white border-b-4 border-pink-200"> {/* Borda rosa */}
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <div className="bg-white p-8 rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300 border border-pink-300"> {/* Borda rosa */}
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300 border border-pink-300">
      ...
      <section className="py-16 px-4 bg-white border-b-4 border-pink-200">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-extrabold text-pink-600 mb-12">
            Bônus Exclusivos Para Você (Vagas Limitadas!)
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <div className="bg-pink-50 p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-pink-300">
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-purple-500 to-indigo-600 text-white text-center shadow-lg border-b-4 border-pink-200">
        ...
        <div className="bg-yellow-300 text-purple-800 p-6 rounded-lg shadow-2xl inline-block mb-8 animate-pulse border border-pink-500">
        ...
        <a href="#" className="bg-pink-600 hover:bg-pink-700 text-white font-bold py-4 px-8 rounded-full text-2xl md:text-3xl uppercase transition-all duration-300 transform hover:scale-105 shadow-lg border-2 border-white">
