...
export default function Fature4000ComUnhasEm2025() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-gray-300 font-[family-name:var(--font-poppins)]">
      ...
      <div className="bg-black text-white text-center py-3 px-4 relative overflow-hidden">
        <div className="relative z-10">
          <p className="text-sm md:text-base font-bold animate-pulse text-white" style={{ fontFamily: 'var(--font-instrument-serif), serif' }}>
            ...
            <span className="text-[#D4AF37]"> último dia com valor promocional!</span>
          </p>
        </div>
      </div>
      ...
      <header className="bg-black text-[#D4AF37] py-8 px-6 text-center">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-3 leading-tight text-[#D4AF37] scroll-animate animate-fadeIn" data-animate>
          O Método Completo para Faturar com Unhas
        </h1>
        <p className="text-xl md:text-2xl font-semibold text-white mb-3 scroll-animate animate-fadeIn" data-animate>
        ...
        <p className="text-lg md:text-xl font-light max-w-3xl mx-auto text-white mb-4 scroll-animate animate-slideInUp" data-animate>
          Domine as técnicas mais pedidas do mercado pagando <strong className="text-[#D4AF37]">menos de R$ 0,40 por dia</strong>.
        </p>
        <div className="inline-block bg-gray-900/80 border border-[#D4AF37]/50 rounded-xl px-6 py-3 scroll-animate animate-scaleIn" data-animate>
          <p className="text-white text-sm">Investimento equivalente a</p>
          <p className="text-[#D4AF37] text-2xl font-bold">5x de R$ 10,41</p>
      ...
      <section className="py-6 px-6" style={{ backgroundColor: '#000000' }}>
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-extrabold mb-6 scroll-animate animate-fadeIn" style={{ color: '#FFFFFF' }} data-animate>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 scroll-animate animate-fadeInStagger" data-animate>
            <div className="p-4 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-500 flex flex-col items-center transform hover:scale-105 scroll-animate animate-scaleIn" style={{ backgroundColor: '#000000', border: '1px solid #B76E79' }} data-animate>
              ...
              <h3 className="text-xl font-bold mb-2" style={{ color: '#FFFFFF' }}>Perfeito Para Iniciantes</h3>
            ...
            <div className="p-4 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-500 flex flex-col items-center transform hover:scale-105 scroll-animate animate-scaleIn" style={{ backgroundColor: '#000000', border: '1px solid #B76E79' }} data-animate>
              ...
              <h3 className="text-xl font-bold mb-2" style={{ color: '#FFFFFF' }}>Fature +R$4.000/Mês</h3>
              <p className="text-base" style={{ color: '#F9F1F0' }}>
            ...
            <div className="p-4 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-500 flex flex-col items-center transform hover:scale-105 scroll-animate animate-scaleIn" style={{ backgroundColor: '#000000', border: '1px solid #B76E79' }} data-animate>
              ...
              <h3 className="text-xl font-bold mb-2" style={{ color: '#FFFFFF' }}>Certificação Internacional</h3>
              <p className="text-base" style={{ color: '#F9F1F0' }}>
      ...
      <section className="py-6 px-6 bg-black text-white">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-extrabold mb-4 text-white scroll-animate animate-slideInLeft" data-animate>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left scroll-animate animate-slideInUp" data-animate>
            <div className="bg-gray-900 p-4 rounded-lg shadow-xl border border-[#D4AF37] transform hover:scale-105 transition-all duration-300 scroll-animate animate-slideInUp" data-animate>
              <div className="flex items-center mb-3">
                <span className="text-3xl mr-3">📚</span>
                <h3 className="text-xl font-bold text-[#D4AF37]">Módulos Completos e Didáticos</h3>
              </div>
            ...
            <div className="bg-gray-900 p-4 rounded-lg shadow-xl border border-[#D4AF37] transform hover:scale-105 transition-all duration-300 scroll-animate animate-slideInUp" data-animate>
              <div className="flex items-center mb-3">
                <span className="text-3xl mr-3">⭐</span>
                <h3 className="text-xl font-bold text-[#D4AF37]">Diferenciais Exclusivos</h3>
              </div>
              <ul className="text-gray-300 space-y-2 text-base">
      ...
      <section className="py-6 px-6 bg-[#0a0a0a] text-gray-300">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-6 scroll-animate animate-fadeIn" data-animate>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left scroll-animate animate-fadeInStagger" data-animate>
            <div className="space-y-3">
              <div className="flex items-start">
                <span className="text-[#D4AF37] text-xl mr-3 mt-1">✅</span>
        ...
        <div className="text-center mt-6">
          <button
            ...
            className="bg-[#D4AF37] hover:bg-[#F4E4BC] text-black font-bold py-3 px-6 rounded-full text-lg shadow-xl transition-all duration-300 transform hover:scale-105 inline-block animate-bounce cursor-pointer"
      ...
      <section className="py-6 px-6 bg-[#0a0a0a] text-gray-300">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-4 scroll-animate animate-slideInRight" data-animate>
            É Iniciante? Não Precisa de Faculdade Para Ganhar 10 Mil Por Mês!
          </h2>
          <div className="bg-gray-900 p-6 rounded-xl border border-[#D4AF37] mb-6">
            <p className="text-white text-lg leading-relaxed mb-4">
              Mesmo sendo iniciante, com apenas <strong className="text-[#D4AF37]">5x de R$ 10,41</strong> você terá um ensino de alta qualidade — menos de <strong className="text-[#D4AF37]">R$ 10 por mês</strong> para mudar de vida!
            </p>
          ...
          <div className="flex justify-center items-center space-x-8">
            ...
            <div className="text-center">
              ...
              <p className="text-[#D4AF37] font-bold text-xl">5x R$ 10,41</p>
      ...
      <section className="py-8 px-6 bg-black">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 text-[#D4AF37] scroll-animate animate-fadeIn" data-animate>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8 scroll-animate animate-fadeInStagger" data-animate>
            {[
              ...
              <div 
                ...
                data-animate
              >
                <div className="bg-gray-900 rounded-xl border-2 border-[#D4AF37] overflow-hidden shadow-xl">
                  <Image
          ...
          <div className="bg-gray-900 border-2 border-[#D4AF37] p-6 rounded-xl max-w-3xl mx-auto scroll-animate animate-fadeIn" data-animate>
            <h3 className="text-xl font-bold text-[#D4AF37] mb-3">💎 Transformações Reais de Iniciantes</h3>
            <p className="text-white text-base leading-relaxed">
              Estes são apenas alguns dos <strong className="text-[#D4AF37]">centenas de feedbacks</strong> que 
              recebemos diariamente! Muitas alunas começaram do zero absoluto e hoje 
              <strong className="text-[#D4AF37]"> conquistaram sua independência financeira</strong> e se tornaram 
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 scroll-animate animate-fadeInStagger" data-animate>
            <div className="scroll-animate animate-scaleIn" data-animate>
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg border-2 border-[#D4AF37] overflow-hidden shadow-2xl transform hover:scale-105 transition-all duration-300">
                <Image
              ...
              <p className="text-[#D4AF37] font-bold mt-4 text-lg">Módulo 1 - Técnicas Fundamentais</p>
            ...
            <div className="scroll-animate animate-scaleIn" data-animate>
              ...
              <p className="text-[#D4AF37] font-bold mt-4 text-lg">Módulo 2 - Técnicas Avançadas</p>
              <p className="text-white text-base mt-2">Certificação em técnicas profissionais e nail art avançada</p>
            </div>
          </div>
          
          <div className="bg-gray-900 border-2 border-[#D4AF37] p-6 rounded-xl max-w-2xl mx-auto scroll-animate animate-fadeIn" data-animate>
            <h3 className="text-xl font-bold text-[#D4AF37] mb-3">✨ Valorização Profissional</h3>
            <p className="text-white text-base leading-relaxed">
              Estes certificados internacionais não só comprovam sua qualificação, mas também agregam valor aos seus serviços, 
              permitindo que você <strong className="text-[#D4AF37]">cobre mais caro</strong> e seja reconhecida como uma 
              <strong className="text-[#D4AF37]"> profissional certificada</strong> no mercado da beleza.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-6 px-6 bg-[#0a0a0a] text-gray-300">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-extrabold mb-4 text-white scroll-animate animate-fadeIn" data-animate>
            Histórias de Sucesso Reais de Nossas Alunas
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 scroll-animate animate-fadeInStagger" data-animate>
            <div className="bg-gray-900 p-4 rounded-lg shadow-xl border border-[#D4AF37]/30 transform hover:scale-105 transition-all duration-300 scroll-animate animate-fadeIn" data-animate>
              <p className="italic mb-2 text-gray-300 text-base">"Eu era completamente iniciante, nunca tinha mexido com unhas! O curso da Mariana Nails mudou minha vida! Hoje tenho minha própria clientela e faturo mais de R$4.000 por mês!"</p>
              <p className="font-bold text-[#D4AF37] text-sm">Ana Paula, 29 anos - São Paulo/SP</p>
            </div>
            <div className="bg-gray-900 p-4 rounded-lg shadow-xl border border-[#D4AF37]/30 transform hover:scale-105 transition-all duration-300 scroll-animate animate-fadeIn" data-animate>
              <p className="italic mb-2 text-gray-300 text-base">"Comecei do zero absoluto! Sempre amei unhas, mas nunca pensei que poderia viver disso. O curso é super didático, perfeito para iniciantes. Conquistei minha independência!"</p>
              <p className="font-bold text-[#D4AF37] text-sm">Juliana Costa, 35 anos - Rio de Janeiro/RJ</p>
            </div>
            <div className="bg-gray-900 p-4 rounded-lg shadow-xl border border-[#D4AF37]/30 transform hover:scale-105 transition-all duration-300 scroll-animate animate-fadeIn" data-animate>
              <p className="italic mb-2 text-gray-300 text-base">"Entrei como iniciante total e em menos de 3 meses após o curso, já estava com a agenda lotada! A qualidade do ensino é incrível para quem está começando!"</p>
              <p className="font-bold text-[#D4AF37] text-sm">Carla Santos, 25 anos - Belo Horizonte/MG</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-6">
          <button
            ...
            className="bg-[#22C55E] hover:bg-[#16A34A] text-white font-bold py-3 px-6 rounded-full text-lg shadow-xl transition-all duration-300 transform hover:scale-105 inline-block animate-pulse cursor-pointer"
            style={{ fontFamily: 'var(--font-instrument-serif), serif' }}
          >
            Quero começar por 5x de R$ 10,41
          </button>
      ...
      <section className="py-8 px-6 bg-gradient-to-b from-gray-900 to-black text-white">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-[#D4AF37]/15 to-[#C41E3A]/10 border-2 border-[#D4AF37] rounded-2xl p-6 md:p-8">
            <h2 className="text-2xl md:text-3xl font-extrabold text-[#D4AF37] mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-black/50 rounded-xl p-4">
                ...
                <p className="text-[#D4AF37] text-2xl font-bold">R$ 47,00</p>
              </div>
              <div className="bg-black/50 rounded-xl p-4">
      ...
      <section className="py-8 px-6 bg-[#0a0a0a] text-gray-300">
        <div className="max-w-4xl mx-auto text-center">
          
          {/* Stack de Valor */}
          <div className="bg-gray-900 border-2 border-[#D4AF37] p-6 rounded-xl mb-8">
            <h3 className="text-xl font-bold text-[#D4AF37] mb-4">✨ Tudo isso por menos de R$ 10 por mês:</h3>
          ...
          <div className="bg-gradient-to-b from-gray-900 to-black border-4 border-[#D4AF37] p-8 rounded-2xl mb-8">
            <p className="text-gray-400 text-lg mb-1">DE:</p>
            <p className="text-white text-2xl line-through opacity-60 mb-4">R$ 197,00</p>
            
            <p className="text-[#D4AF37] text-lg font-semibold mb-2">POR APENAS:</p>
            <div className="bg-[#D4AF37] text-black inline-block px-6 py-3 rounded-xl mb-4">
              <p className="text-4xl md:text-5xl font-extrabold">5x de R$ 10,41</p>
            </div>
            <p className="text-white text-lg">ou <strong className="text-[#D4AF37]">R$ 47,00</strong> à vista</p>
          ...
          <div className="bg-gray-900/50 border border-gray-700 rounded-xl p-6 mb-8 text-left">
            <h4 className="text-[#D4AF37] font-bold text-lg mb-3 text-center">
              🤔 "Por que um conteúdo tão completo por um valor tão acessível?"
            </h4>
            <p className="text-white text-base leading-relaxed">
              "Eu poderia cobrar facilmente <strong className="text-[#D4AF37]">R$ 297</strong> por esse treinamento. 
              Mas meu objetivo hoje não é o lucro imediato — é <strong className="text-[#D4AF37]">criar o maior case de sucesso 
              de Nail Designers do Brasil</strong>. Eu quero que você entre, tenha resultados incríveis e seja a 
              <strong className="text-[#D4AF37]"> prova viva</strong> de que meu método funciona. Por isso, derrubei a barreira de entrada."
            </p>
            <p className="text-right text-white mt-3 font-semibold">— Mariana Nails</p>
          </div>
          ...
          <div className="mb-6">
            <button
              ...
              className="bg-[#D4AF37] hover:bg-[#F4E4BC] text-black font-bold py-4 px-8 rounded-full text-lg md:text-xl transition-all duration-300 transform hover:scale-105 shadow-lg inline-block cursor-pointer"
            >
      ...
      <section className="py-6 px-6 bg-[#0a0a0a] text-gray-300">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-[#D4AF37] leading-relaxed">
      ...
      <section className="py-6 px-6 bg-[#0a0a0a] text-gray-300">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-extrabold mb-4 text-[#D4AF37] text-center">
            Perguntas Frequentes (FAQ)
          </h2>
          <div className="space-y-4">
            <div className="bg-gray-900 p-4 rounded-lg shadow-md border border-[#D4AF37]/30">
              <h3 className="text-xl font-bold mb-2 text-[#D4AF37]">Sou totalmente iniciante. Esse curso é para mim?</h3>
              <p className="text-gray-300 text-base">SIM! O curso foi feito especialmente para iniciantes! Você vai aprender do absoluto zero, mesmo que nunca tenha pegado em uma lixa. Explicamos tudo passo a passo!</p>
            </div>
            <div className="bg-gray-900 p-4 rounded-lg shadow-md border border-[#D4AF37]/30">
              <h3 className="text-xl font-bold mb-2 text-[#D4AF37]">Preciso ter todos os materiais para começar?</h3>
              <p className="text-gray-300 text-base">Não! No curso ensinamos detalhadamente quais materiais você precisará, onde comprá-los com os melhores preços e como montar seu kit inicial de iniciante.</p>
            </div>
            <div className="bg-gray-900 p-4 rounded-lg shadow-md border border-[#D4AF37]/30">
              <h3 className="text-xl font-bold mb-2 text-[#D4AF37]">Quanto custa o curso?</h3>
              <p className="text-gray-300 text-base">O curso vale R$ 197,00, mas hoje você paga em até <strong>5x de R$ 10,41</strong> (ou R$ 47 à vista)! Acesso vitalício, sem mensalidades ou taxas escondidas.</p>
            </div>
            <div className="bg-gray-900 p-4 rounded-lg shadow-md border border-[#D4AF37]/30">
              <h3 className="text-xl font-bold mb-2 text-[#D4AF37]">Recebo certificados ao finalizar o curso?</h3>
              <p className="text-gray-300 text-base">Sim! Ao concluir os módulos, você receberá 3 certificados internacionais, que comprovam sua qualificação e são reconhecidos no mercado da beleza.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-6 px-6 bg-[#0a0a0a] text-gray-300">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-4 scroll-animate animate-scaleIn" data-animate>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 scroll-animate animate-fadeInStagger" data-animate>
            {[
              ...
              <div key={img} className="overflow-hidden rounded-lg border border-[#D4AF37]/30 shadow-sm hover:shadow-lg transition-all">
                <Image
      ...
      {showEmailModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fadeIn">
          <div className="relative bg-gradient-to-b from-gray-900 to-black border-2 border-[#D4AF37] rounded-2xl p-6 max-w-md w-full shadow-2xl animate-scaleIn max-h-[90vh] overflow-y-auto">
            {/* Botão Fechar */}
            <button
            ...
            {/* Título */}
            <h3 className="text-2xl font-bold text-[#D4AF37] text-center mb-3">
            ...
            <div className="bg-gray-800/50 rounded-xl p-4 mb-4">
              <p className="text-[#D4AF37] text-sm font-bold mb-3 text-center">
            ...
            <div className="space-y-3">
              ...
              <div>
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-gray-800 border-2 border-gray-700 text-white placeholder-gray-400 focus:border-[#D4AF37] focus:outline-none transition-colors text-base"
                  autoFocus
                />
                {emailError && (
              ...
              <button
                ...
                className="w-full bg-[#D4AF37] hover:bg-[#F4E4BC] text-black font-bold py-4 px-6 rounded-lg text-lg transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
      ...
      <footer className="bg-black text-white py-3 px-6 text-center pb-24">
        ...
        <p className="text-xs">Suporte: <a href="mailto:suporte@mariananails.com" className="text-[#D4AF37] hover:underline">suporte@mariananails.com</a></p>
      </footer>
      ...
      <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-50 px-4 w-full max-w-xs">
        <div className="bg-black/95 backdrop-blur-sm border border-[#D4AF37]/60 rounded-xl p-3 shadow-2xl">
          {/* Botão Garantir Minha Vaga */}
          <button
            onClick={() => handleCheckoutClick('fixed-bottom-button')}
            className="block w-full bg-[#D4AF37] hover:bg-[#F4E4BC] text-black font-bold py-3 px-4 rounded-full text-sm shadow-xl transition-all duration-300 transform hover:scale-105 text-center cursor-pointer"
          >
