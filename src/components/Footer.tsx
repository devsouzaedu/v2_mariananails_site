        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            ...
            <p className="text-gray-300 max-w-xs mt-4">
              Especialista em nail design, oferecendo serviços de alta qualidade em Santana de Parnaíba no Mariana Nails Studio.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start">
                ...
                Rua Veneza, 468, Jardim Isaura - Santana de Parnaíba, SP
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-[#D4AF37]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="https://wa.me/5511944598264" target="_blank" rel="noopener noreferrer" className="hover:text-[#D4AF37] transition-colors">
                  (11) 94459-8264
                </a>
              </li>
              <li className="flex items-start">
